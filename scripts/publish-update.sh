...
test -e "$RUNTIME/price_lists_domain/issued_offers/corporate_renderer.py"
test -e "$RUNTIME/price_lists_domain/issued_offers/assets/turto_offer_header.jpg"
test -e "$RUNTIME/price_lists_domain/issued_offers/assets/turto_offer_footer.jpg"
