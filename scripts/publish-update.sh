...
for f in \
  ...
  v644_default_date_sort.py v710_cleanup.py post_baseline.py
do
...
grep -q "crm_features.install_offer_ui(app);crm_price_lists.apply(app);v710_cleanup.apply(app)" "$DIR/ZakazkyCRM.pyw"
