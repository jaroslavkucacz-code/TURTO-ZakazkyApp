...
def ui_checks(td):
    ...
    try:
        ...
        # Tk/Win32 emits an unknown ("??") keysym for synthesized KP_Enter.
        # If no real Enter event was synthesized, invoke the installed Tcl
        # command; genuine key events must still pass through the binding.
        keys = []
