...
from src.data_import import preview_imports,apply_imports,parse_file,number
from src.report_model import Analytics,collect_report
from src.management import collect_management,customer_changes
...
class ImportTests(unittest.TestCase):
    ...
    def test_reports_missing_comparison_partial_profit_and_exports(self):
        ...
        from src.exports import export_excel
        from src.reporting import build_html
