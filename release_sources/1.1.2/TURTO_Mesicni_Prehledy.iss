...
SetupIconFile=..\..\_stage_112\assets\app_icon.ico
...
[InstallDelete]
; Od 1.1.0 už nepoužíváme samostatný PyInstaller updater, který může blokovat WDAC/App Control.
Type: files; Name: "{app}\TURTO_Mesicni_Prehledy_Updater.exe"

[Files]
Source: "..\..\dist\TURTO Mesicni Prehledy\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{group}\TURTO – Měsíční přehledy"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; AppUserModelID: "cz.turto.mesicni-prehledy"
Name: "{autodesktop}\TURTO – Měsíční přehledy"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; AppUserModelID: "cz.turto.mesicni-prehledy"; Tasks: desktopicon

[Run]
Filename: "{app}\{#MyAppExeName}"; Parameters: "--turto-repair-shortcuts"; StatusMsg: "Sjednocuji zástupce programu…"; Flags: runhidden waituntilterminated
